...
def min_cost_perf_matching(total_num_edges, total_num_nodes, subgraph):
	...
	for edge in subgraph:
		# convert tuple to string     (8, 9, 0)  -->   "8 9 0"
		st = ""
	...
	os.system("utils/blossom5-v2.05.src/blossom5 -e utils/blossom_graph_files/subgraph.txt \
		-w utils/blossom_graph_files/solution.txt")
